...
<head>
  ...
  <!-- Custom CSS - Same styling as login -->
  <style>
    * {
...
<div class="login-page">
  ...
  <div class="login-left">
    ...
    <div class="illustration-content">
      ...
      <div class="welcome-subtitle">Secure Your Account</div>
      <div class="welcome-description">
        Choose a strong password to protect your BOM System account and ensure data security.
      </div>
    </div>
  </div>
        ...
        <div class="card-body">
          ...
          @else
            ...
            <div class="user-info-box">
              <h6><i class="fas fa-user-check mr-2"></i>Verified Account</h6>
          ...
          <form action="{{ route('password.update') }}" method="POST" id="resetPasswordForm">
            ...
            @else
              ...
              <div class="input-group mb-3">
                <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" 
                       placeholder="Enter NIP to reset" value="{{ old('nip') }}" required>
            ...
            <div class="input-group mb-3">
              <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" 
                     placeholder="New Password" required id="passwordField">
              <div class="input-group-append">
            ...
            <div class="input-group mb-3">
              <input type="password" name="password_confirmation" class="form-control" 
                     placeholder="Confirm New Password" required id="passwordConfirmField">
              <div class="input-group-append">
            ...
            <div id="passwordMatchIndicator" class="mb-3" style="display: none;">
...
$(document).ready(function() {
  ...
  function checkPasswordMatch() {
    ...
    if (password && confirmPassword) {
      indicator.show();
      if (password === confirmPassword) {
        matchText.html('<i class="fas fa-check text-success mr-1"></i>Passwords match').removeClass('text-danger').addClass('text-success');
      } else {
        matchText.html('<i class="fas fa-times text-danger mr-1"></i>Passwords do not match').removeClass('text-success').addClass('text-danger');
      }
    } else {
      indicator.hide();
    }
  ...
  $('#resetPasswordForm').on('submit', function(e) {
    ...
    resetBtn.html('<i class="fas fa-spinner fa-spin mr-2"></i>PROCESSING...');
  });
