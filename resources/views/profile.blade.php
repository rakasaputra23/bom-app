  ...
  <div class="col-md-8">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="text-muted">Politeknik Negeri Madiun</p>
        <hr>
        <strong><i class="fas fa-map-marker-alt mr-1"></i> Lokasi</strong>
        <p class="text-muted">Sidoarjo, Jawa Timur</p>
        <hr>
        ...
        <p class="text-muted">
          ...
          <span class="tag tag-info">Networking</span>
          <span class="tag tag-warning">HTML</span>
          <span class="tag tag-primary">UI/UX</span>
        </p>
        <hr>
        <strong><i class="far fa-file-alt mr-1"></i> Catatan</strong>
        <p class="text-muted">Ini adalah akun demo yang menampilkan informasi profil pengguna.</p>
      </div>
    </div>
  </div>
</div>
